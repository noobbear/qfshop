...
<script type="text/javascript">
	...
	function gotoShopcar(){
		...
		location.href ="ShoppingServlet?method=gotoShopping&count="+count+"&id="+${goodsInfo.id}+"&key="+${key};
	}
	
	function buynow(){
		var count = document.getElementById("value").value;
		location.href ="ShoppingServlet?method=paynow&count="+count+"&id="+${goodsInfo.id}+"&key="+${key};
	}
				...
				<div class="tb-detail-list">
					...
					<div class="tb-detail-price">
						...
						<li class="price iteminfo_price">
							...
							<dd>
								<em>¥</em><b class="sys_item_price">${goodsInfo.goods_price}</b>
							</dd>
						</li>
									...
									<form class="theme-signin" action="" method="post">
										...
										<div class="theme-signin-left">
											...
											<div class="theme-options">
												...
												<dd>
													<input id="min" class="am-btn am-btn-default" name="" type="button" value="-" onclick="jian()"/> 
													<input id="value" name="pic" type="text" value="1" style="width: 30px;" /> 
													<input id="add" class="am-btn am-btn-default" name="" type="button" value="+" onclick="jia()" /> 
