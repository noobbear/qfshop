	...
	<head>
		...
		<script type="text/javascript">
		 function jian(goodId){
				...
				location.href="ShopCatServlet?method=update&pay=1&count="+count+"&id="+goodId;
			}
					...
					<div class="address">
						...
						<ul class="addressChoose">
							<c:forEach items="${addressList}" var="address">
								<c:if test="${address.isdefault eq '否'}">
									<li class="user-addresslist ">
										<div class="address-left">
											<div class="user DefaultAddr">
												 <span class="buy-address-detail"></span>
		                  						 <span class="buy-user">收货人：${address.shouhuoren}</span>
											</div>
											<div class="user DefaultAddr">
												 <span class="buy-address-detail"></span>
												 <span class="buy-phone">电话：${address.phone}</span>
											</div>
					...
					<c:forEach items="${shop_cat.list}" var="good">
								...
								<div class="bundle  bundle-last">
									...
									<div class="bundle-main">
										<ul class="item-content clearfix">
												...
												<li class="td td-item">
													<div class="item-pic">
														<a href="#" class="J_MakePoint">
															<img src="images/${good.goods_pic}" style="width: 80px; height: 80px" class="itempic J_ItemImg"></a>
													</div>
													<div class="item-info">
														<div class="item-basic-info">
															<a href="#" class="item-title J_MakePoint" data-point="tbcart.8.11">${good.goods_description}</a>
														</div>
													</div>
												</li>						
												<li class="td td-price">
													<div class="item-price price-promo-promo">
														<div class="price-content">
															...
															<div class="price-line"> 
																<em class="J_Price price-now" id="priceNow${good.id}" tabindex="0">${good.goods_price}</em>
															</div>
														</div>
													</div>
												</li>
											...
											<li class="td td-amount">
												<div class="amount-wrapper ">
													<div class="item-amount ">
														...
														<div class="sl">
															<input class="min am-btn" name="" type="button" value="-" id="jian" onclick="jian(${good.id})"/> 
															<input class="text_box" id="count${good.id}" type="text" value="${good.count}"
													          style="width: 30px; text-align: center;"/> 
													          <input class="add am-btn" name="" type="button" value="+"  id="jia" onclick="jia(${good.id})"/>
											...
											<li class="td td-sum">
												<div class="td-inner">
													<em tabindex="0" class="J_ItemSum number" id="singlePrice${good.id}"><fmt:formatNumber type="number" value="${good.goods_price*good.count}" maxFractionDigits="1"/></em>
												</div>
											</li>
							...
							<div class="order-go clearfix">
								<div class="pay-confirm clearfix">
                                    ...
                                    <span>¥</span> <em class="style-large-bold-red " id="J_ActualFee">${shop_cat.totalPrice}</em>
											</span>
										</div>
									...
									<div id="holyshit269" class="submitOrder">
										...
										<form action="OrderServlet?method=add" method="post" id="form">
