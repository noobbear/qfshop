...
<script type="text/javascript">
	 function jian(goodId){
		...
		location.href="ShopCatServlet?method=update&count="+count+"&id="+goodId;
	}
	...
	<div class="concent">
					...
					<div class="bundle  bundle-last ">
						...
						<c:forEach items="${shop_cat.list}" var="good">
							<ul class="item-content clearfix">
								...
								<li class="td td-sum">
									<div class="td-inner">
										<em tabindex="0" class="J_ItemSum number" ><fmt:formatNumber value="${good.count * good.goods_price}" type="number" maxFractionDigits="1"/></em>
									</div>
								</li>
								<li class="td td-op">
									<div class="td-inner">
									<a href="ShopCatServlet?method=delete&id=${good.id}" data-point-url="#" class="delete"> 删除</a>
									</div>
								</li>
		...
		<div class="float-bar-wrapper">
			...
			<div class="float-bar-right">
				...
				<div class="btn-area">
					<a href="ShoppingServlet?method=paynow" id="J_Go" class="submit-btn submit-btn-disabled"
